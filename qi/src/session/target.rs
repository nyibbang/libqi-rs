...
mod tests {
    use super::*;
    use crate::value::FormatInto;
    use std::net::Ipv4Addr;

    #[test]
    fn targets_from_bytes() {
        let data = [
            0x02u8, 0x00, 0x00, 0x00, 0x0d, 0x00, 0x00, 0x00, 0x71, 0x69, 0x3a, 0x43, 0x61, 0x6c,
        ...
        .as_slice();
        let endpoints = data.to_reflect_args::<Vec<Target>>().unwrap();
        assert_eq!(
            endpoints,
            [
